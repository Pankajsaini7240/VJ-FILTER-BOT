...
API_ID = int(environ.get('API_ID', '22476319'))
API_HASH = environ.get('API_HASH', 'af0f21506a1c0ca49d6c4141c43e3157')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002204525116'))
